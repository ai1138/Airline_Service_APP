...
function CustomerPortal()
{
   ...
   <div style = {{display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center"}}>
      ...
      <div style = {{display: 'flex', width: `${PurchaseNewTickets || NewFlightShown || NewAirplaneShown || NewAirportShown ? '50%' : '100%'}`,  alignItems: 'center', flexDirection: 'column'}}>
      ...
      <div style = {{display: 'flex', width: `${PurchaseNewTickets || NewRating|| NewAirplaneShown || NewAirportShown ? '50%' : '100%'}`,  alignItems: 'center', flexDirection: 'column'}}>
